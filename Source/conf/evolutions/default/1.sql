...
alter table hearthstone_participation add constraint fk_hearthstone_participation_p_2 foreign key (participation_id) references participation (id) on delete restrict on update restrict;
create index ix_hearthstone_participation_p_2 on hearthstone_participation (participation_id);
alter table hearthstone_participation add constraint fk_hearthstone_participation_d_3 foreign key (deck1_id) references hearthstone_deck (id) on delete restrict on update restrict;
create index ix_hearthstone_participation_d_3 on hearthstone_participation (deck1_id);
alter table hearthstone_participation add constraint fk_hearthstone_participation_d_4 foreign key (deck2_id) references hearthstone_deck (id) on delete restrict on update restrict;
create index ix_hearthstone_participation_d_4 on hearthstone_participation (deck2_id);
alter table hearthstone_participation add constraint fk_hearthstone_participation_d_5 foreign key (deck3_id) references hearthstone_deck (id) on delete restrict on update restrict;
...
alter table participation add constraint fk_participation_participant_7 foreign key (participant_email) references user (email) on delete restrict on update restrict;
